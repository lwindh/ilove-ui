...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, className = props.className, disabled = props.disabled, size = props.size, children = props.children, href = props.href, shape = props.shape, rest = __rest(props, ["btnType", "className", "disabled", "size", "children", "href", "shape"]);
