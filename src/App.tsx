...
function App() {
  ...
  return (
    <>
      ...
      <Button btnType='text' target='_block'>Text Button</Button>
      <Button btnType='link' href="https://www.baidu.com" target='_block'>Link Button</Button>
      ...
      <Button btnType='primary' size={size}> Primary </Button>
      <Button btnType='danger' size={size}> Danger </Button>
      <Button btnType='link' size={size} href="https://www.baidu.com" target='_block'> Link </Button>
      <Button shape="round" size={size}>圆角按钮</Button>
